        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (treeView1.SelectedNode.Text.Equals("Caja"))
                {
                    ...
                    String insertar = "insert into Activos(Activo, Monto) values (@Activo, @Monto)";
                    SqlCommand cmd1 = new SqlCommand(insertar);
                    cmd1.Parameters.AddWithValue("@Activo", treeView1.SelectedNode.Text.Equals("Caja"));
                    cmd1.Parameters.AddWithValue("@Monto", maskedTextBox1.Text);
                ...
                else if (treeView1.SelectedNode.Text.Equals("Instituciones Bancarias"))
                {
                    ...
                    String insertar = "insert into Activos(Activo, Monto) values (@Activo, @Monto)";
                    SqlCommand cmd1 = new SqlCommand(insertar);
                    cmd1.Parameters.AddWithValue("@Activo", treeView1.SelectedNode.Text.Equals("Instituciones Bancarias"));
                    cmd1.Parameters.AddWithValue("@Monto", maskedTextBox1.Text);
                ...
                else if (treeView1.SelectedNode.Text.Equals("Inversiones Disponibles Para La Venta"))
                {
                    ...
                    String insertar = "insert into Activos(Activo, Monto) values (@Activo, @Monto)";
                    SqlCommand cmd1 = new SqlCommand(insertar);
                    cmd1.Parameters.AddWithValue("@Activo", treeView1.SelectedNode.Text.Equals("Inversiones Disponibles Para La Venta"));
                    cmd1.Parameters.AddWithValue("@Monto", maskedTextBox1.Text);
                ...
                else if (treeView1.SelectedNode.Text.Equals("Documentos Por Cobrar"))
                {
                    ...
                    String insertar = "insert into Activos(Activo, Monto) values (@Activo, @Monto)";
                    SqlCommand cmd1 = new SqlCommand(insertar);
                    cmd1.Parameters.AddWithValue("@Activo", treeView1.SelectedNode.Text.Equals("Documentos Por Cobrar"));
                    cmd1.Parameters.AddWithValue("@Monto", maskedTextBox1.Text);
                ...
                else if (treeView1.SelectedNode.Text.Equals("Inversiones Mantenidas Hasta El Vencimineto"))
                {
                    ...
                    String insertar = "insert into Activos(Activo, Monto) values (@Activo, @Monto)";
                    SqlCommand cmd1 = new SqlCommand(insertar);
                    cmd1.Parameters.AddWithValue("@Activo", treeView1.SelectedNode.Text.Equals("Inversiones Mantenidas Hasta El Vencimineto"));
                    cmd1.Parameters.AddWithValue("@Monto", maskedTextBox1.Text);
                ...
                else if (treeView1.SelectedNode.Text.Equals("Inventario"))
                {
                    ...
                    String insertar = "insert into Activos(Activo, Monto) values (@Activo, @Monto)";
                    SqlCommand cmd1 = new SqlCommand(insertar);
                    cmd1.Parameters.AddWithValue("@Activo", treeView1.SelectedNode.Text.Equals("Inventario"));
                    cmd1.Parameters.AddWithValue("@Monto", maskedTextBox1.Text);
                ...
                else if (treeView1.SelectedNode.Text.Equals("Edificio"))
                {
                    ...
                    String insertar = "insert into Activos(Activo, Monto) values (@Activo, @Monto)";
                    SqlCommand cmd1 = new SqlCommand(insertar);
                    cmd1.Parameters.AddWithValue("@Activo", treeView1.SelectedNode.Text.Equals("Edificio"));
                    cmd1.Parameters.AddWithValue("@Monto", maskedTextBox1.Text);
                ...
                else if (treeView1.SelectedNode.Text.Equals("Vehiculos"))
                {
                    ...
                    String insertar = "insert into Activos(Activo, Monto) values (@Activo, @Monto)";
                    SqlCommand cmd1 = new SqlCommand(insertar);
                    cmd1.Parameters.AddWithValue("@Activo", treeView1.SelectedNode.Text.Equals("Vehiculos"));
                    cmd1.Parameters.AddWithValue("@Monto", maskedTextBox1.Text);
                ...
                else if (treeView1.SelectedNode.Text.Equals("Maquinaria"))
                {
                    ...
                    String insertar = "insert into Activos(Activo, Monto) values (@Activo, @Monto)";
                    SqlCommand cmd1 = new SqlCommand(insertar);
                    cmd1.Parameters.AddWithValue("@Activo", treeView1.SelectedNode.Text.Equals("Maquinaria"));
                    cmd1.Parameters.AddWithValue("@Monto", maskedTextBox1.Text);
                ...
                else if (treeView1.SelectedNode.Text.Equals("Planta y equipo"))
                {
                    ...
                    String insertar = "insert into Activos(Activo, Monto) values (@Activo, @Monto)";
                    SqlCommand cmd1 = new SqlCommand(insertar);
                    cmd1.Parameters.AddWithValue("@Activo", treeView1.SelectedNode.Text.Equals("Planta y equipo"));
                    cmd1.Parameters.AddWithValue("@Monto", maskedTextBox1.Text);
                ...
                else if (treeView1.SelectedNode.Text.Equals("Inversiones De Largo Plazo"))
                {
                    ...
                    String insertar = "insert into Activos(Activo, Monto) values (@Activo, @Monto)";
                    SqlCommand cmd1 = new SqlCommand(insertar);
                    cmd1.Parameters.AddWithValue("@Activo", treeView1.SelectedNode.Text.Equals("Inversiones De Largo Plazo"));
                    cmd1.Parameters.AddWithValue("@Monto", maskedTextBox1.Text);
                ...
                else if (treeView1.SelectedNode.Text.Equals("Otros Activos"))
                {
                    ...
                    String insertar = "insert into Activos(Activo, Monto) values (@Activo, @Monto)";
                    SqlCommand cmd1 = new SqlCommand(insertar);
                    cmd1.Parameters.AddWithValue("@Activo", treeView1.SelectedNode.Text.Equals("Otros Activos"));
                    cmd1.Parameters.AddWithValue("@Monto", maskedTextBox1.Text);
                ...
                else if (treeView1.SelectedNode.Text.Equals("Activo Diferido"))
                {
                    ...
                    String insertar = "insert into Activos(Activo, Monto) values (@Activo, @Monto)";
                    SqlCommand cmd1 = new SqlCommand(insertar);
                    cmd1.Parameters.AddWithValue("@Activo", treeView1.SelectedNode.Text.Equals("Activo Diferido"));
                    cmd1.Parameters.AddWithValue("@Monto", maskedTextBox1.Text);
        ...
        private void btnAddPasivo_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (treeView2.SelectedNode.Text.Equals("Documentos Por Pagar"))
                {
                    ...
                    String insertar = "insert into Pasivos(Pasivo, Monto) values (@Pasivo, @Monto)";
                    SqlCommand cmd1 = new SqlCommand(insertar);
                    cmd1.Parameters.AddWithValue("@Pasivo", treeView1.SelectedNode.Text.Equals("Documentos Por Pagar"));
                    cmd1.Parameters.AddWithValue("@Monto", maskedTextBox1.Text);
                ...
                else if (treeView2.SelectedNode.Text.Equals("Cuentas Por Pagar"))
                {
                    ...
                    String insertar = "insert into Pasivos(Pasivo, Monto) values (@Pasivo, @Monto)";
                    SqlCommand cmd1 = new SqlCommand(insertar);
                    cmd1.Parameters.AddWithValue("@Pasivo", treeView1.SelectedNode.Text.Equals("Cuentas Por Pagar"));
                    cmd1.Parameters.AddWithValue("@Monto", maskedTextBox1.Text);
                ...
                else if (treeView2.SelectedNode.Text.Equals("Otros Pasivos"))
                {
                    ...
                    String insertar = "insert into Pasivos(Pasivo, Monto) values (@Pasivo, @Monto)";
                    SqlCommand cmd1 = new SqlCommand(insertar);
                    cmd1.Parameters.AddWithValue("@Pasivo", treeView1.SelectedNode.Text.Equals("Otros Pasivos"));
                    cmd1.Parameters.AddWithValue("@Monto", maskedTextBox1.Text);
                }
                else if (treeView2.SelectedNode.Text.Equals("Documentos Por Pagar Relacionados"))
                {
                    ...
                    String insertar = "insert into Pasivos(Pasivo, Monto) values (@Pasivo, @Monto)";
                    SqlCommand cmd1 = new SqlCommand(insertar);
                    cmd1.Parameters.AddWithValue("@Pasivo", treeView1.SelectedNode.Text.Equals("Documentos Por Pagar Relacionados"));
                    cmd1.Parameters.AddWithValue("@Monto", maskedTextBox1.Text);
                }
                else if (treeView2.SelectedNode.Text.Equals("Documentos Por Pagar a Bancos"))
                {
                    ...
                    String insertar = "insert into Pasivos(Pasivo, Monto) values (@Pasivo, @Monto)";
                    SqlCommand cmd1 = new SqlCommand(insertar);
                    cmd1.Parameters.AddWithValue("@Pasivo", treeView1.SelectedNode.Text.Equals("Documentos Por Pagar a Bancos"));
                    cmd1.Parameters.AddWithValue("@Monto", maskedTextBox1.Text);
                }
                else if (treeView2.SelectedNode.Text.Equals("Otros Pasivos No Corrientes"))
                {
                    ...
                    String insertar = "insert into Pasivos(Pasivo, Monto) values (@Pasivo, @Monto)";
                    SqlCommand cmd1 = new SqlCommand(insertar);
                    cmd1.Parameters.AddWithValue("@Pasivo", treeView1.SelectedNode.Text.Equals("Otros Pasivos No Corrientes"));
                    cmd1.Parameters.AddWithValue("@Monto", maskedTextBox1.Text);
                }
            }
        }
